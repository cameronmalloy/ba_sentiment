...
ACCESS_KEY = '115834680-62JRJsx5lHoCTFHFddsFuEORh19KtAd5O95fL647'
ACCESS_SECRET = 'JAjdOCsm19wXR5ZiJtbaClkDoDh4ggU8FFvM8JhsRakq6'
...
def main():
    ...
    # get fetch list
    print 'got totaling list'
    total_list = read_total_list( user_params['inList'] )
    print 'got fetching list'
